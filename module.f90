module all
    ...
    type everything
        ...
        integer :: i, j, nx, ny, nz, sou_position, ice_position, rock_position
        ...
        real(8), allocatable :: epr(:, :), mur(:, :), Ex(:, :), Ey(:, :), Hx(:, :), Hy(:, :)
...
contains
    ...
    subroutine EverythingInit(this) ! Initialize everything
        ...
        this%nx = 500 ! Number of points
        this%ny = 500 ! Number of points
        this%sou_position = 250 ! Source position
        ...
        allocate(this%epr(this%nx, this%ny), this%mur(this%nx+1, this%ny+1)) ! Allocate arrays
        allocate(this%Hx(this%nx+1, this%ny+1), this%Hy(this%nx, this%ny)) ! Allocate arrays
        allocate(this%Ex(this%nx, this%ny), this%Ey(this%nx+1, this%ny+1)) ! Allocate arrays
        ...
        this%Hy = 0.0 ! Set all magnetic fields to zero
        this%Ey = 0.0 ! Set all electric fields to zero
        this%Hx = 0.0 ! Set all magnetic fields to zero
        ...
        open(29, file='Hy.txt', status='old') ! Open text files
    ...
    subroutine EverythingFini(this) ! Deallocate everything
        ...
        deallocate(this%epr, this%mur, this%Ex, this%Hy) ! Deallocate arrays
    ...
    subroutine WriteToText(this) ! Write everything to text files
        ...
        write(29,'(100000(1G13.3e3))') this%Hy ! Write Hy to Hy.txt
    ...
    subroutine GaussianSource(this, t) ! Gaussian source
        ...
        ! Gaussian source
        this%Ex(this%sou_position, this%sou_position) = this%Ex(this%sou_position, this%sou_position) &
            + exp(-(t-this%t0)**2/this%tau**2) * sin(this%w0*t*this%dt)/this%imp
        this%Hy(this%sou_position, this%sou_position) = this%Hy(this%sou_position, this%sou_position) &
            - exp(-(t-this%t0)**2/this%tau**2) * sin(this%w0*t*this%dt)/this%imp
    ...
    subroutine UpdateMagneticField(this) ! Update magnetic field
        ...
        do concurrent(i = 2:this%nx, j = 1:this%ny) ! Update Hx
            this%Hx(i, j) = this%Hx(i, j) + this%dt / (this%mu0 * this%mur(i, j))*(this%Ey(i, j) - this%Ey(i, j-1)) / this%dz
        end do

        do concurrent(i = 1:this%nx, j = 1:this%ny) ! Update Hy
            this%Hy(i, j) = this%Hy(i, j) + this%dt / (this%mu0 * this%mur(i, j))*(this%Ex(i, j) - this%Ex(i-1, j)) / this%dz
        end do
    ...
    subroutine UpdateElectricField(this) ! Update electric field
        ...
        do concurrent(i = 1:this%nx, j = 1:this%ny) ! Update Ex
            this%Ex(i, j) = this%Ex(i, j) + this%dt/(this%eps0 * this%epr(i, j))*(this%Hy(i+1, j) - this%Hy(i, j)) / this%dz
        end do

        do concurrent(i = 2:this%nx, j = 2:this%ny) ! Update Ey
            this%Ey(i, j) = this%Ey(i, j) + this%dt/(this%eps0 * this%epr(i, j))*(this%Hx(i, j+1) - this%Hx(i, j)) / this%dz
        end do
    ...
    subroutine BoundaryConditions(this) ! Boundary conditions
        ...
        ! Boundary conditions
        this%Hy(1, :) = this%Hy(2, :) ! Set Hy at the left boundary to the value of the second boundary
        this%Hy(this%nx, :) = this%Hy(this%nx-1, :) ! Set Hy at the right boundary to the value of the second to right boundary
        this%Hy(:, 1) = this%Hy(:, 2) ! Set Hy at the bottom boundary to the value of the second boundary
        this%Hy(this%nx+1, :)   = this%Hy(this%nx, :) ! Set Hy at the second to right boundary to the value of the third to right boundary
